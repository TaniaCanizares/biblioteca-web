(function ($) {
	...
	var llenarBib = function () {
		...
		var libro1 = new libro("0", "It", "Stephen King", "Terror", "1", "3", "0",
		...
		var libro3 = new libro("2", "El club de los mejores", "Arthur Gunn", "Ficcion", "1", "3", "2",
		...
		var libro4 = new libro("3", "El juego de Ender", "Orson Card", "Ficcion", "1", "3", "2",
		...
		var libro5 = new libro("4", "Un misterio en Toledo", "Anne Perry", "Misterio", "1", "3", "2",
		...
		var libro6 = new libro("5", "El castillo", "Luis Zueco", "Ficcion", "1", "3", "2",
		...
		var libro7 = new libro("6", "Nosotros", "Evgueni Zamiatin", "Ficcion", "1", "3", "2",
		...
		var libro8 = new libro("7", "Matadero cinco", "Kurt Vonnegut", "Ficcion", "1", "3", "2",
